      ...
      >
        <g>
          <path
            fill="currentColor"
            className="st0"
            d="M256,0.004C114.609,0.021,0.016,114.613,0,256.004c0.016,141.39,114.609,255.974,256,255.992
		...
		C469.087,314.913,445.281,368.049,406.683,406.68z"
          ...
          <path
            fill="currentColor"
            className="st0"
            d="M256,61.888C148.94,61.905,61.909,148.945,61.892,256.004C61.909,363.047,148.94,450.095,256,450.112
		...
		c32.06,32.069,51.887,76.255,51.887,125.058C432.946,304.799,413.119,348.985,381.058,381.063z"
          ...
          <path
            fill="currentColor"
            className="st0"
            d="M198.8,226.306c-17.967,0-32.564,14.598-32.564,32.556s14.598,32.555,32.564,32.555
		c17.949,0,32.546-14.597,32.546-32.555S216.75,226.306,198.8,226.306z"
          />
          <path
            fill="currentColor"
            className="st0"
            d="M313.2,226.306c-17.949,0-32.547,14.598-32.547,32.556s14.598,32.555,32.547,32.555
